...
public class AccelerometerLinearSensor implements SensorEventListener {
    ...
    public AccelerometerLinearSensor(Context context, SensorDataListener sensorDataListener) {
    ...
    private void loadLiveDataonSocketServer(SensorAxisData sensorAxisData) {
        sensorDataListener.accelerometerData("ACLINEAR/"+sensorAxisData.getA_timer()+"/"+sensorAxisData.getB_xValue()+"/"+sensorAxisData.getC_yValue()+"/"+sensorAxisData.getD_zValue());
    }
