...
public class GyroscopeSensor implements SensorEventListener {
    ...
    public GyroscopeSensor(Context context, SensorDataListener sensorDataListener) {
    ...
    private void loadLiveDataonSocketServer(SensorAxisData sensorAxisData) {
        sensorDataListener.gyroscopeData("GYR/"+sensorAxisData.getA_timer()+"/"+sensorAxisData.getB_xValue()+"/"+sensorAxisData.getC_yValue()+"/"+sensorAxisData.getD_zValue());
    }
